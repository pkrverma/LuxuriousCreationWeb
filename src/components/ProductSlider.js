      ...
      {pages.map((page, index) => {
        return (
          <SwiperSlide key={index}>
            <div className="grid grid-cols-2 gap-x-5 md:grid-cols-3 lg:grid-cols-4 lg:gap-[30px]  lg:max-w-[1000px] xl:max-w-[1200px] mx-auto">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-x-3">
                      <div>₹ {price}</div>
                      <div className="text-[15px] text-gray-500 line-through">₹ {oldPrice}</div>
                    </div>
                  </div>
                );
              })}
